...
export const BANK_TXN_NOTE_LABEL: Record<string, string> = {
  ...
  deposit_under: "Cọc giữ ngày chuyển thiếu, chưa xác nhận: nhận luôn số này làm cọc, hoặc bỏ qua",
  deposit_accepted: "Cọc chuyển thiếu, studio đã nhận đúng số này làm cọc",
